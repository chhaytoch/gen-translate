...
namespace Frontend\LangBundle\Controller;
...
class LangController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $langs = $em->getRepository('LangBundle:Lang')->findAll();
    ...
    {
        $lang = new Lang();
        $form = $this->createForm('Frontend\LangBundle\Form\LangType', $lang);
    ...
    {
        $deleteForm = $this->createDeleteForm($lang);
        $editForm = $this->createForm('Frontend\LangBundle\Form\LangType', $lang);
